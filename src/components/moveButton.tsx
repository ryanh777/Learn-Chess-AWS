...
const MoveButton = (props: Props) => {
  ...
  return (
    <div 
      className="flex flex-col items-center h-20 px-2 py-1 m-1 text-lg rounded-lg shadow-md bg-button hover:bg-buttonHover hover:cursor-pointer" 
      onClick={handleClick}>
      {(() => {
         switch(props.child.piece) {
            case "wp": {
